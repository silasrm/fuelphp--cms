...
return array(
	 ...
	 */
	'roles' => array(
		'#'  => array('Controller_Site', 'Controller_Admin' => array('login', 'sair')),
		'user'  => array(
			'Controller_Admin' => array('login', 'sair'), 
			'Controller_Admin_Pagina' => array('index', 'create', 'view'),
			'Controller_Admin_Foto' => array('index', 'create', 'view'),
		),
		'super' => true,
		/**
		 * Examples
	 ...
	 */
	'login_hash_salt' => 'eyL@/47F(HXZMMJsmM2(',
